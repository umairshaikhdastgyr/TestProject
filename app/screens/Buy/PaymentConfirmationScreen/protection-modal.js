...
import {
  View, Text, PixelRatio,ScrollView, TouchableOpacity, StyleSheet, Dimensions, Platform, Modal
} from 'react-native';
      ...
      <View style={{ padding: 80, paddingHorizontal: 20, backgroundColor: '#00000080', flex: 1 }}>
        <View style={{ borderRadius: 10, overflow: 'hidden', flex: 1 }}>
          ...
          {/* <View style={styles.detailConatiner}>
            <Text style={styles.detailText}>We want to ensure the best experience for you. That’s why we’ve created the Homitag Buyer Protection</Text>
          </View> */}
          <ScrollView style={styles.dataConatiner}>
            ...
            {/* <Accordion
              sections={(contents && contents[0]?.Contents) ? contents[0]?.Contents : []}
