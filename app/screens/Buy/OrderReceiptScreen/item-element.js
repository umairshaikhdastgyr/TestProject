...
const ItemElement = ({
  ...
  <View style={{ flexDirection: 'row', width: '100%', marginBottom: 18 }}>
    ...
    >
      <Text style={!float && txtType === 'bold' ? [styles.rightBoldText,{color:textColor?textColor:'black'}]: [styles.rightText,{color:textColor?textColor:'black'}]}>{rightLabel}</Text>
    </View>
  </View>
