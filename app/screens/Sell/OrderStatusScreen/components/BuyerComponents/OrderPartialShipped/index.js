...
const OrderPartialShipped = ({ orderData, onViewReceipt, storeName }) => {
        ...
        <View style={styles.orderStatusText}>
          <OrderStatusTitle
            orderStatusValue={
              ...
              ` (${orderData?.calculationValues?.shippedInfo?.quantity}/${orderData?.quantity})`
            }
...
export default OrderPartialShipped;
