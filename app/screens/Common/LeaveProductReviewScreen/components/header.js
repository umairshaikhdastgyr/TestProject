...
const HeaderLeaveProductReviews = ({ handleGoBack, headerOpacity }) => {
  return (
    <SafeAreaView style={[styles.header, { height: 60 }]}>
      ...
      >
        ...
        <Text style={styles.headerText}>Leave a Product Review</Text>
...
export default HeaderLeaveProductReviews;
